...
import com.example.util.ConstraintViolationExceptionHandler;
...
public class UserController {
    ...
    public ModelAndView list(@RequestParam(value="async",required = false)boolean async,
        ...
        return new ModelAndView(async==true?"users/list::#mainContainReplace":"users/list","userModel",model);
    }
    ...
    public ModelAndView createForm(Model model){
        ...
        return new ModelAndView("model/add","userModel",model);
    }
